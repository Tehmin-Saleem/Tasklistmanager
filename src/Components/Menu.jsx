  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-white shadow">
      <div className="md:w-64 bg-white shadow">
        ...
        <div className="mt-7 ml-6 py-3 px-3 md:h-11 md:w-52 bg-white rounded-xl flex border-2 border-[#F1F5F9] text-[#4BCBEB]">
          <Dashboard />
          <Link to="/dashboard" className="ml-2 text-[#4BCBEB]">
            <button className="px-2 font-bold text-sm ">Dashboard</button>
          </Link>
        </div>
        <div className="flex mt-3 ml-6 py-3 px-3 md:h-11 md:w-52 text-[#4BCBEB]">
          <MenuUser />
          <Link to="/users" className="ml-2 text-[#4BCBEB]">
            <button className="px-2 font-medium text-sm text-[#64748B]">Users</button>
          </Link>
        </div>
        <div className="flex mt-3 ml-6 py-3 px-3 md:h-11 md:w-52 text-[#4BCBEB]">
          <TaskIcon />
          <Link to="/tasks" className="ml-2 text-[#4BCBEB]">
            <button className="px-2 font-medium text-sm text-[#64748B]">Tasks</button>
          </Link>
        </div>
        <div className="flex mt-3 ml-6 py-3 px-3 md:h-11 md:w-52 text-[#4BCBEB]">
          <SettingsIcon />
          <Link to="/settings" className="ml-2 text-[#4BCBEB]">
