    ...
    <div className="main flex justify-center items-center h-screen">
      ...
      <div className="right w-1/2  h-full pt-[100px] ">
        <div className="flex flex-col mx-[100px] ">
          ...
          <h6>Enter the email address associated with your account <br/> 
        ...
        <button className="cursor-pointer ml-[130px] mt-[30px] text-[#4BCBEB] font-bold text-lg">Back to sign in</button>
